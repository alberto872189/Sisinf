...
class Main {
	public static void main(String args[]) {
		int id = 4;//incrementar en 3 cada vez que se prueba, si se borran las tablas resetear a 1
		int id2 = 3;//incrementar en 2 cada vez que se prueba, si se borran las tablas resetear a 1
